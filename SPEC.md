...
- Foto "Ferro" della sezione materiale in Home (`materiali/categorie_prodotti/ferro.jpeg`) è un'anteprima Shutterstock a bassa risoluzione (389×280px) con watermark "shutterstock.com" ancora visibile nell'immagine pubblicata: pubblicata temporaneamente su richiesta di Antonino (2026-08-04), da sostituire con una foto reale/licenziata appena disponibile. Anche `acciaio.jpeg`/`alluminio.jpeg` sembrano foto stock generiche (non dell'officina): da valutare se sostituire con foto reali quando disponibili
